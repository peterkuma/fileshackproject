...
// Load this file's selection again by visiting: http://mootools.net/more/d27f0021e6d51da6cf8b5983ba128ca2 
// Or build this file again with packager using: packager build More/More More/Date More/Element.Shortcuts More/Fx.Reveal
/*
---
copyrights:
...
Locale.addEvent("change",function(s){if(Locale.get("Date")){b(s);}}).fireEvent("change",Locale.getCurrent());})();Element.implement({isDisplayed:function(){return this.getStyle("display")!="none";
