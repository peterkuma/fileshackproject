# Django settings for fileshackproject.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db/fileshack.sqlite'), # Or path to database file if using sqlite3.
...
SECRET_KEY = '-nn1sd&amp;@mo4q4oztc*$c*d!l11)&amp;%q@dxa^(zbtte6m1q#4_p_'
...
ROOT_URLCONF = 'fileshackproject.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fileshackproject.wsgi.application'
